...
namespace SyncObjX.Data
{
    public class SqlInsertFactory
    {
        ...
        public SqlInsertFactory(string tableName, string primaryKeyColumnName, Dictionary<string, string> fieldsAndValues)
        {
        ...
        public SqlInsertFactory(string tableName, string primaryKeyColumnName, string primaryKeyValue, Dictionary<string, string> fieldsAndValues)
        {
        ...
        public SqlInsertFactory(string tableName, List<string> primaryKeyColumnNames, List<string> primaryKeyValues, Dictionary<string, string> fieldsAndValues)
        {
            IsAutoPrimaryKey = false;
        ...
        public SqlInsertFactory(string tableName, string primaryKeyColumn, object customCommand, Dictionary<string, string> fieldsAndValues)
        {
            IsAutoPrimaryKey = false;
        ...
        public string GetSQL(bool addPrimaryKeyOutput)
        {
            try
            {
                ...
                else if (CustomCommand != null && CustomCommand is string)
