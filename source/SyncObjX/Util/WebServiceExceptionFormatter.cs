...
{
    public class WebServiceExceptionFormatter
    {
        public static string FormatException(string componentName, WebServiceException ex)
        {
            ...
            do
            {
                ...
                msg.AppendLine("Exception Type: " + ex.SourceExceptionTypeName);
